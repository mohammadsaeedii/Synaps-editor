...
export const ICONS = {
  ...
  newChat: `<path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h9.5A2.5 2.5 0 0 1 18 6.5v4.5A2.5 2.5 0 0 1 15.5 13.5H9.5l-3.2 2.6A.8.8 0 0 1 5 15.6V6.5Z" stroke="currentColor" stroke-width="1.5"/><path d="M17 17v3M15.5 18.5h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
  newFile: `<path d="M12 3.5H7.5a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2V9l-5.5-5.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 3.5V9h5.5" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M17 17v3M15.5 18.5h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
  newFolder: `<path d="M3.5 7A1.8 1.8 0 0 1 5.3 5.2h3l1.6 1.7h5.5A1.8 1.8 0 0 1 16.4 8.7V14a1.8 1.8 0 0 1-1.8 1.8H5.3A1.8 1.8 0 0 1 3.5 14V7Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M17 17v3M15.5 18.5h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
